    ...
    return (
        <div className='relative'>
            <select
                ...
                className='relative border border-white/50 rounded-md py-0.5 pl-3.5 sm:pl-5'>
                <EachUtils
                    of={LIST_LANGUAGE}
                    render={(item, index) => (
                        <option
            ...
            <div className='absolute top-1/2 -translate-y-1/2 left-1'>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-3 sm:size-4.5">
